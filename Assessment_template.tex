...
Caitlin Allen Akselrud\textsuperscript{1}\\
...
This assessment reports the status of the Pacific Cod
(\emph{Gaddus Macrocephalus}) resource in U.S. waters off the coast of
the California, Oregon, and Washington using data through 2013.
Etc\ldots{}
...
\caption{Pacific Cod landings in \ldots{}.. \label{fig:Exec_catch1}}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{Assessment_template_files/figure-latex/unnamed-chunk-3-1.pdf}
\caption{Stacked line plot of Pacific Cod landings history for Oregon by
...
\caption{Stacked line plot of Pacific Cod landings history for
...
\caption{Landings history of Pacific Cod. \label{fig:r4ss_catches}}
\end{figure}

\begin{table}[ht]
\centering
\caption{Recent Pacific Cod landings (mt) by 
                                            fleet.} 
...
Pacific Cod was assessed\ldots{}. This assessment uses the newest
...
\caption{Recent trend in beginning of the 
                                      ...
                                      the base model for Pacific Cod.} 
...
\caption{Time series of estimated Pacific Cod recruitments for the
...
A summary of Pacific Cod exploitation histories for base model is
...
\caption{Recent trend in spawning potential 
                                        ratio and exploitation for Pacific Cod in the base model.  Fishing intensity is (1-SPR) 
...
This stock assessment estimates that Pacific Cod in the base model are
above the biomass target, but above the minimum stock size threshold.
...
This stock assessment estimates that Pacific Cod in the are
...
Data used in the Pacific Cod assessment are summarized in Figure
\ref{fig:data_plot}.\\
...
3\_WA\_NorthernWA\_Rec\_PR: 0.9797 (0.6417\_2.2289)
